	...
	: QMainWindow(parent)
{
	...
	mode->setRootPath("D:\\Users\\V\\Documents\\Visual Studio 2013\\Projects\\QtTest\\Win32\\applications");

	mModel = new QStandardItemModel();
	mModel->setColumnCount(2);
	mModel->setHeaderData(0, Qt::Horizontal, QString::fromLocal8Bit("Name"));
	mModel->setHeaderData(1, Qt::Horizontal, QString::fromLocal8Bit("ÐÕÃû"));
	...
	bool res = watcher->addPath(BianMa->toUnicode("D:\\Users\\V\\Documents\\Visual Studio 2013\\Projects\\QtTest\\Win32\\applications\\app1 - ¸±±¾ (24).desktop"));
...
void QtTest::loadDir()
{
	...
	mDesktopItemDir.setPath("D:\\Users\\V\\Documents\\Visual Studio 2013\\Projects\\QtTest\\Win32\\applications");
	int errcode;
